# Generated by Powerlevel10k configuration wizard on 2020-10-25 at 10:25 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 00302.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, blurred heads, blurred tails, 1 line, sparse, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #googe_app_cred         # google application credentials (https://cloud.google.com/docs/authentication/production)
